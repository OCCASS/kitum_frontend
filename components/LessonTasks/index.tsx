...
export default function LessonTasks({ data }: { data: ILesson }) {
    ...
    return (
        <div className="space-y-2 max-w-prose m-auto">
            ...
            <div className="flex justify-between items-center">
                ...
                {(isAllAnswered && !lesson.isTasksCompleted) && <Button onClick={complete} disabled={lesson.isTasksCompleted} variant="outline" className="text-sm">Завершить</Button>}
            </div>
            {/* Content */}
            <Tasks
                tasks={lesson?.tasks ?? []}
